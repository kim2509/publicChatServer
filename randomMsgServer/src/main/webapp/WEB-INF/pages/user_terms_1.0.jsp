...
<br/>
이 약관은 TES SOFT ("회사" 또는 "이근처")가 제공하는 이근처 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.<br/>
<br/>
제 2 조 (정의)<br/>
<br/>
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.<br/>
<br/>
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 이근처 관련 제반 서비스를 의미합니다.<br/>
...
<br/>
	...
	2.현재 위치를 활용한 검색결과 제공 서비스: 정보 검색 요청 시 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용한 검색결과 및 주변결과(카풀/합승정보)를 제시합니다.<br/>
