...
<br/>
이 약관은 TES SOFT ("회사" 또는 "이근처 합승")가 제공하는 이근처 합승 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.<br/>
<br/>
제 2 조 (정의)<br/>
<br/>
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.<br/>
<br/>
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 이근처 합승 관련 제반 서비스를 의미합니다.<br/>
②"회원"이라 함은 회사의 "서비스"에 접속하여 이 약관에 따라 "회사"와 이용계약을 체결하고 "회사"가 제공하는 "서비스"를 이용하는 고객을 말합니다.<br/>
③"임시 아이디(ID)"라 함은 "회원"의 식별과 "서비스" 이용을 위하여 임의로 생성되는 문자와 숫자의 조합을 의미합니다.<br/>
...
제 6 조 (회원정보의 변경)<br/>
<br/>
①"회원"은 개인정보관리화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만, 서비스 관리를 위해 필요한 실명, 아이디, 성별 등은 수정이 불가능합니다.<br/>
...
제 7 조 (개인정보보호 의무)<br/>
<br/>
"회사"는 "정보통신망법" 등 관계 법령이 정하는 바에 따라 "회원"의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련법 및 "회사"의 개인정보취급방침이 적용됩니다. 다만, "회사"의 공식 어플리케이션(사이트) 이외의 링크된 사이트에서는 "회사"의 개인정보취급방침이 적용되지 않습니다.<br/>
<br/>
...
②"회사"는 서비스와 관련하여 "회원"에게 "회사"가 정한 이용조건에 따라 계정, "아이디", 콘텐츠, "포인트" 등을 이용할 수 있는 이용권만을 부여하며, "회원"은 이를 양도, 판매, 담보제공 등의 처분행위를 할 수 없습니다.<br/>
<br/>
제 18 조 (포인트)<br/>
<br/>
"회사"는 서비스의 효율적 이용 및 운영을 위해 사전 공지 후 "포인트"의 일부 또는 전부를 조정할 수 있으며, "포인트"는 회사가 정한 기간에 따라 주기적으로 소멸할 수 있습니다.<br/>
<br/>
제 19 조 (계약해제, 해지 등)<br/>
<br/>
①"회원"은 온오프라인 요청을 통하여 이용계약 해지 신청을 할 수 있으며, "회사"는 관련법 등이 정하는 바에 따라 이를 즉시 처리하여야 합니다.<br/>
...
⑥"회원"은 본 조에 따른 이용제한 등에 대해 이의신청을 할 수 있습니다. 이 때 이의가 정당하다고 "회사"가 인정하는 경우 "회사"는 즉시 "서비스"의 이용을 재개합니다.<br/>
<br/>
제 21 조 (책임제한)<br/>
<br/>
...
제 1 조 (목적)<br/>
<br/>
이 약관은 TES SOFT (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.<br/>
<br/>
제 2 조 (약관 외 준칙)<br/>
<br/>
이 약관에 명시되지 않은 사항은 위치정보의 보호 및 이용 등에 관한 법률, 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 전기통신기본법, 전기통신사업법 등 관계법령과 회사의 이용약관 및 개인정보취급방침, 회사가 별도로 정한 지침 등에 의합니다.<br/>
<br/>
...
<br/>
	...
	2.현재 위치를 활용한 검색결과 제공 서비스: 정보 검색 요청 시 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용한 검색결과 및 주변결과(합승정보)를 제시합니다.<br/>
	3.현재 위치를 활용한 친구찾기 및 친구맺기: 현재 위치를 활용하여 친구를 찾아주거나 친구를 추천하여 줍니다.<br/>
	4.연락처 교환하기: 현재 위치를 활용하여 친구와 연락처를 교환할 수 있습니다.<br/>
...
<br/>
	①휴대전화 단말기를 이용한 기지국 기반(Cell ID방식)의 실시간 위치정보 수집<br/>
	②GPS칩이 내장된 전용 단말기를 통해 수집되는 GPS 정보를 통한 위치정보 수집<br/>
	③Wi-Fi칩이 내장된 전용 단말기를 통해 수집되는 Wi-Fi 정보를 통한 위치정보 수집<br/>
	④스마트폰, 태블릿PC 등 전자 단말기의 운영체계(Operation System)에서 제공하는 위치정보 API를 통해 제공받는 위치정보의 수집<br/>
<br/>
제 5 조 (개인위치정보주체의 권리)<br/>
<br/>
...
<br/>
제 10 조 (8세 이하의 아동 등의 보호의무자의 권리)<br/>
<br/>
...
제 13 조  (사업자 정보)<br/>
<br/>
회사의 상호, 주소, 이메일 주소 그 밖의 연락처는 다음과 같습니다.<br/>
<br/>
상호 : 테스소프트(TES Soft)<br/>
주소 : 서울시 관악구 인헌 12가길 36 드림하우스 404호<br/>
이메일 주소 : nearheretaxi@gmail.com<br/>
<br/>
부칙<br/>
<br/>
제1조 시행일<br/>
<br/>
본 약관은 2015년 2월 9일부터 적용됩니다.<br/>
<br/>
