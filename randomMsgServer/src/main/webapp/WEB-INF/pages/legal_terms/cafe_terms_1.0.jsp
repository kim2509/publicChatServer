...
<body>
	...
	<div id="wrapper">
		...
		<div class="cafe_rule">
	        ...
	        <p class="desc_rule">본 약관은 회원(이근처 약관에 동의하는 자를 말합니다. 이하 “회원”이라고 합니다)이 테스소프트(이하 “회사”라고 합니다)가 제공하는 이근처 카페 서비스(이하 “서비스”라고 합니다)를 이용함에 있어 회원과 회원의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>
	        ...
	        <ul class="list_rule">
	            <li><span class="txt_num">1.</span><span class="txt_rule">이근처 카페 서비스</span></li>
	        ...
	        <p class="desc_rule"><span class="txt_num">②</span><span class="txt_rule">“카페주인”라 함은 아래 각 호의 자를 말합니다.</span></p>
	        <ul class="list_rule">
	            <li><span class="txt_num">1.</span><span class="txt_rule">카페를 개설한 자</span></li>
	            <li><span class="txt_num">2.</span><span class="txt_rule">회사가 정하는 정상적인 절차에 따라 하자 없이 이전 카페주인으로부터 카페를 양도받거나 카페 지기의 부재 등의 사유로 카페지기로 임명된 자</span></li>
	        </ul>
	        <p class="desc_rule"><span class="txt_num">③</span><span class="txt_rule">“운영자” 라 함은 카페주인이 선정하여 운영자로 지정한 해당 카페의 회원을 말합니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">④</span><span class="txt_rule">“운영 권한”이라 함은 카페의 폐쇄, 회원의 정보 열람, 등급 변경, 접근 금지 및 강제 탈퇴, 게시물의 이동 및 삭제 등 카페를 정상적으로 운영하기 위해 필요한 권한을 말하며 카페주인은 서비스에 지정된 모든 운영 권한을 가집니다.</span></p>
	        ...
	        <p class="desc_rule"><span class="txt_num">⑥</span><span class="txt_rule">본 약관에서 사용하는 용어 중 본 조에서 정하지 아니한 것은 이근처 이용약관, 이근처 카페 운영원칙 및 관계 법령에서 정하는 바에 따르며, 그 외에는 일반 관례에 따릅니다.</span></p>
	        ...
	        <ul class="list_rule">
	            ...
	            <li><span class="txt_num">10.</span><span class="txt_rule">회사 또는 제3자에게 피해를 미칠 수 있어 이근처 이용약관, 이근처 카페 운영원칙 등에 따라 회사가 게재를 금지한 내용을 게재할 목적인 경우</span></li>
	        ...
	        <p class="desc_rule"><span class="txt_num">③</span><span class="txt_rule">카페주인은 카페주인의 권한을 운영자 또는 카페회원에게 양도할 수 있으며, 카페주인의 권한을 양도하는 경우 카페주인의 권한은 상실됩니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">④</span><span class="txt_rule">카페주인은 카페주인 외 다른 회원이 없는 경우 관리자 화면에서 ‘폐쇄’를 클릭함으로써 카페를 자진폐쇄 할 수 있습니다. 카페주인 외 다른 회원이 있는 경우 카페주인는 카페의 폐쇄를 사전에 고지하고 회원이 모두 탈퇴한 후 카페를 폐쇄할 수 있습니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">⑤</span><span class="txt_rule">카페주인이 자진폐쇄한 카페는 복구할 수 없습니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">⑥</span><span class="txt_rule">카페주인은 그 계정정보 및 관리에 대한 철저한 보안의무가 있고, 카페주인이나 운영자 본인의 관리소홀로 인해 패스워드가 타인에게 유출되어 카페 운영에 문제가 발생한 경우 그로 인한 책임은 카페주인이나 운영자에게 있으며 삭제된 카페 자료는 복구할 수 없습니다.</span></p>
	        ...
	        <p class="desc_rule"><span class="txt_num">②</span><span class="txt_rule">카페 회원이 본 약관 및/또는 이근처 카페 운영원칙에 위배되는 행위를 한 경우 모든 관리책임은 1차적으로 카페지기가 부담하며, 회사의 시정요구에도 불구하고 별도의 조치나 시정이 안될 경우 회사는 카페지기 및/또는 회원의 자격을 박탈하거나 서비스의 이용을 중지 또는 제한할 수 있습니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">③</span><span class="txt_rule">카페주인의 자격이 박탈되거나 카페주인이 이근처 서비스에서 탈퇴한 경우, 카페주인이 카페주인으로서의 권한을 정상적으로 유지하지 못할 경우 회사는 운영원칙에 따라 카페를 기존 운영자 중 신청자에게 양도할 수 있으며, 카페주인 자격이 박탈되거나 카페가 양도된 경우 기존 카페주인의 모든 운영 권한은 상실됩니다.</span></p>
	        ...
	        <p class="desc_rule"><span class="txt_num">①</span><span class="txt_rule">카페 내 모든 게시물 및 콘텐츠의 관리 및 운영 권한은 카페 운영진 또는 해당 게시물 및 콘텐츠를 게시한 회원에게 있습니다. 단, 카페주인 및/또는 운영자의 요청이 있거나 기타 회사가 카페의 원활한 운영을 위하여 필요하다고 판단할 경우, 회사는 게시물의 관리 등과 관련한 사항을 개선, 지원하는 등의 활동을 할 수 있습니다.</span></p>
	        ...
	        <p class="desc_rule"><span class="txt_num">②</span><span class="txt_rule">카페 회원은 본 약관이나 이근처 이용약관, 이근처 카페 운영원칙에서 금지하는 내용의 게시물을 카페 내에 등록할 수 없으며, 이를 위반하여 발생하는 책임은 게시물 작성자에게 있습니다.</span></p>
	        ...
	        <p class="desc_rule"><span class="txt_num">④</span><span class="txt_rule">카페 회원은 본 조의 의무 외, 이근처 이용약관 제 13조에서 정한 회원의 의무를 부담합니다.</span></p>
	        <strong class="tit_rule">제 12 조 (카페지기의 권한 및 의무)</strong>
	        <p class="desc_rule"><span class="txt_num">①</span><span class="txt_rule">카페주인(운영자를 포함합니다. 이하 본 조에서 동일합니다)는 관련 법령과 본 약관을 준수하는 범위 내에서 본인이 개설하거나 운영하는 카페의 가입 조건을 설정할 수 있으며, 해당 카페의 가입 방식 및 조건에 따라 가입 신청한 회원의 가입 신청 승낙 여부를 결정할 수 있습니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">②</span><span class="txt_rule">카페주인은 관련 법령과 본 약관의 내용을 준수하여 해당 카페에 가입하고자 하는 회원으로부터 일정한 정보를 제공 받을 수 있으며, 카페 운영원칙에 따라 해당 정보들은 카페주인의 책임 하에 관리, 운영됩니다. 카페주인은 어떠한 경우에도 카페 회원의 사전 서면 허락 없이 개인의 신상정보를 타인에게 제공하거나 공개할 수 없으며, 이를 위반하여 발생하는 모든 책임은 카페주인에게 있습니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">③</span><span class="txt_rule">카페주인은 법령과 약관을 준수하는 범위 내에서 카페 회원의 활동 범위 및 등급을 지정할 수 있는 권한과 그에 따른 책임이 있습니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">④</span><span class="txt_rule">카페주인은 카페에 대한 운영 권한이 있으며 이로 인한 일체의 책임을 부담하고, 카페 회원과 카페주인 사이에 발생한 모든 법적인 분쟁에 대한 책임을 부담합니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">⑤</span><span class="txt_rule">카페주인은 카페주인 외 제3자의 홍보메일 등을 일부 또는 전부의 카페 회원을 상대로 발송하는 경우 대상 회원에게 사전에 해당 사실을 알려야 합니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">⑥</span><span class="txt_rule">본인이 운영하던 카페를 타인에게 양도하는 카페주인은 카페 양도 전 최소 15일 간, 그 양도의 사실을 공지사항으로 게시하고 이메일을 통해 카페 회원에게 고지하여야 합니다. 타인이 운영하던 카페를 양도받은 카페주인은 카페를 양도받은 후 최소 15일 간, 그 양도의 사실을 공지사항으로 게시하고 이메일을 통해 카페 회원에게 고지하여야 합니다.</span></p>
	        <p class="desc_rule"><span class="txt_num">⑦</span><span class="txt_rule">카페주인은 카페를 영리목적으로 운영하는 경우 본 약관 및 카페 운영원칙에서 정한 사항 외에도 "정보통신망 이용촉진 및 정보보호등에 관한 법률", "전자상거래 등에서의 소비자보호에 관한 법률" 등 관련 법령상 책임을 부담합니다.</span></p>
	        <strong class="tit_rule">제 13 조 (약관 외 준칙)</strong>
	        <p class="desc_rule"><span class="txt_num">①</span><span class="txt_rule">본 약관에 명시하지 않은 사항은 이근처 이용약관에 따르며, 본 약관과 이근처 이용약관의 내용이 충돌하는 경우 본 약관의 내용이 우선합니다.</span></p>
	        ...
	        <p class="desc_rule">본 약관은 2016. 12. 28.부터 적용됩니다. 단, 본 약관의 공지 이후 시행일 이전에 본 약관에 동의한 경우에는 동의 시부터 본 약관이 적용됩니다.</p>
